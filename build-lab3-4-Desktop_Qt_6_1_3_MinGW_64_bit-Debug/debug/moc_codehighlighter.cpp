...
#include <memory>
#include "../../LabFolder/codehighlighter.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CodeHighlighter_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_CodeHighlighter_t qt_meta_stringdata_CodeHighlighter = {
    {
...
static const uint qt_meta_data_CodeHighlighter[] = {
...
const QMetaObject CodeHighlighter::staticMetaObject = { {
    QMetaObject::SuperData::link<QSyntaxHighlighter::staticMetaObject>(),
    qt_meta_stringdata_CodeHighlighter.offsetsAndSize,
